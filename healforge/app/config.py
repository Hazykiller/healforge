...
class Settings:
    ...
    sandbox_build_network: str = os.getenv("SANDBOX_BUILD_NETWORK", "default").strip().lower()
    max_sandbox_file_bytes: int = _env_int("MAX_SANDBOX_FILE_BYTES", 2_000_000)
    max_sandbox_context_bytes: int = _env_int("MAX_SANDBOX_CONTEXT_BYTES", 50_000_000)
